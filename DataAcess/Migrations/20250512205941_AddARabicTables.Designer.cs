...
namespace DataAcess.Migrations
{
    ...
    [Migration("20250512205941_AddARabicTables")]
    partial class AddARabicTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.ArabicDomain.المكونات", b =>
                {
                    b.Property<int>("بطاقة_المكون")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("بطاقة_المكون"));

                    b.Property<string>("اسم_المكون")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("بطاقة_المكون");
            ...
            modelBuilder.Entity("Models.ArabicDomain.وصفة_المكونات", b =>
                {
                    ...
                    b.HasKey("بطاقة_الوصفة", "بطاقة_المكون");

                    b.HasIndex("بطاقة_المكون");

                    b.ToTable("وصفة_المكونات");
                });
            ...
            modelBuilder.Entity("Models.Domain.UserAllergy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Models.Domain.UserDisease", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Models.ArabicDomain.التغذية", b =>
                {
                    b.HasOne("Models.ArabicDomain.الوصفات", "الوصفة")
                        .WithOne("التغذية")
                        .HasForeignKey("Models.ArabicDomain.التغذية", "بطاقة_الوصفة")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Models.ArabicDomain.وصفة_المكونات", b =>
                {
                    b.HasOne("Models.ArabicDomain.المكونات", "المكون")
                        ...
                        .HasForeignKey("بطاقة_المكون")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Models.ArabicDomain.الوصفات", "الوصفة")
                        .WithMany("وصفة_المكونات")
                        .HasForeignKey("بطاقة_الوصفة")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
